                        ...
                        if (iResult >= 0)
                        {
                            ...
                            if (CommonProperty.prop_bIsOfflinePos)
                            {
                                string[] straQueries = new string[]
                                {
                                    ...
                                    "INSERT INTO TableFormControl (FkFormId, FkParentId, Name, FormControlFunction1, FormControlFunction2, TypeNo, Type, Width, Height, LocationX, LocationY, StartPosition, Caption1, Caption2, List, Dock, Alignment, TextAlignment, CharacterCasing, Font, Icon, ToolTip, Image, ImageSelected, FontAutoHeight, FontSize, InputType, TextImageRelation, BackColor, ForeColor, KeyboardValue) VALUES (2, 0, 'EXIT', 'EXIT_APPLICATION', NULL, 1, 'BUTTON', 100, 100, 1, 643, NULL, 'EXIT', NULL, NULL, NULL, NULL, 'CENTER', 'UPPER', 'Tahoma', NULL, NULL, NULL, NULL, 1, 18, 'ALPHANUMERIC', NULL, NULL, NULL, NULL);",
                                    "INSERT INTO TableFormControl (FkFormId, FkParentId, Name, FormControlFunction1, FormControlFunction2, TypeNo, Type, Width, Height, LocationX, LocationY, StartPosition, Caption1, Caption2, List, Dock, Alignment, TextAlignment, CharacterCasing, Font, Icon, ToolTip, Image, ImageSelected, FontAutoHeight, FontSize, InputType, TextImageRelation, BackColor, ForeColor, KeyboardValue) VALUES (2, 0, 'DEPARTMENT1', 'SALE_DEPARTMENT', NULL, 1, 'BUTTON', 100, 100, 1, 1, NULL, 'MISCELLANEOUS', NULL, NULL, NULL, NULL, 'CENTER', 'UPPER', 'Tahoma', NULL, NULL, NULL, NULL, 1, 18, 'ALPHANUMERIC', NULL, NULL, NULL, NULL);",
                                    "INSERT INTO TableFormControl (FkFormId, FkParentId, Name, FormControlFunction1, FormControlFunction2, TypeNo, Type, Width, Height, LocationX, LocationY, StartPosition, Caption1, Caption2, List, Dock, Alignment, TextAlignment, CharacterCasing, Font, Icon, ToolTip, Image, ImageSelected, FontAutoHeight, FontSize, InputType, TextImageRelation, BackColor, ForeColor, KeyboardValue) VALUES (2, 0, 'SALESLIST', 'SALE_OPTION', NULL, 4, 'SALESLIST', 700, 240, 321, 1, NULL, '', NULL, NULL, NULL, NULL, 'CENTER', 'UPPER', 'Tahoma', NULL, NULL, NULL, NULL, 1, 0, 'ALPHANUMERIC', NULL, NULL, NULL, NULL);",
                                    "INSERT INTO TableFormControl (FkFormId, FkParentId, Name, FormControlFunction1, FormControlFunction2, TypeNo, Type, Width, Height, LocationX, LocationY, StartPosition, Caption1, Caption2, List, Dock, Alignment, TextAlignment, CharacterCasing, Font, Icon, ToolTip, Image, ImageSelected, FontAutoHeight, FontSize, InputType, TextImageRelation, BackColor, ForeColor, KeyboardValue) VALUES (2, 0, 'NUMPAD', 'SALE_PLU_BARCODE', NULL, 5, 'NUMPAD', 230, 298, 791, 1, NULL, '', NULL, NULL, NULL, NULL, 'CENTER', 'UPPER', 'Tahoma', NULL, NULL, NULL, NULL, 1, 0, 'ALPHANUMERIC', NULL, NULL, NULL, NULL);",
                                    "INSERT INTO TableFormControl (FkFormId, FkParentId, Name, FormControlFunction1, FormControlFunction2, TypeNo, Type, Width, Height, LocationX, LocationY, StartPosition, Caption1, Caption2, List, Dock, Alignment, TextAlignment, CharacterCasing, Font, Icon, ToolTip, Image, ImageSelected, FontAutoHeight, FontSize, InputType, TextImageRelation, BackColor, ForeColor, KeyboardValue) VALUES (2, 0, 'PAYMENTLIST', 'PAYMENTLIST', NULL, 6, 'PAYMENTLIST', 230, 196, 791, 1, NULL, '', NULL, NULL, NULL, NULL, 'CENTER', 'UPPER', 'Tahoma', NULL, NULL, NULL, NULL, 1, 0, 'ALPHANUMERIC', NULL, NULL, NULL, NULL);",
                                    "INSERT INTO TableFormControl (FkFormId, FkParentId, Name, FormControlFunction1, FormControlFunction2, TypeNo, Type, Width, Height, LocationX, LocationY, StartPosition, Caption1, Caption2, List, Dock, Alignment, TextAlignment, CharacterCasing, Font, Icon, ToolTip, Image, ImageSelected, FontAutoHeight, FontSize, InputType, TextImageRelation, BackColor, ForeColor, KeyboardValue) VALUES (2, 0, 'AMOUNTSTABLE', 'AMOUNTSTABLE', NULL, 7, 'AMOUNTSTABLE', 250, 200, 1, 155, NULL, '', NULL, NULL, NULL, NULL, 'CENTER', 'UPPER', 'Tahoma', NULL, NULL, NULL, NULL, 1, 0, 'ALPHANUMERIC', NULL, NULL, NULL, NULL);",
                                    "INSERT INTO TableFormControl (FkFormId, FkParentId, Name, FormControlFunction1, FormControlFunction2, TypeNo, Type, Width, Height, LocationX, LocationY, StartPosition, Caption1, Caption2, List, Dock, Alignment, TextAlignment, CharacterCasing, Font, Icon, ToolTip, Image, ImageSelected, FontAutoHeight, FontSize, InputType, TextImageRelation, BackColor, ForeColor, KeyboardValue) VALUES (2, 0, 'PLU19020001', 'SALE_PLU_CODE', NULL, 1, 'BUTTON', 100, 100, 1, 102, NULL, 'BREAD', NULL, NULL, NULL, NULL, 'CENTER', 'UPPER', 'Tahoma', NULL, NULL, NULL, NULL, 1, 18, 'ALPHANUMERIC', NULL, NULL, NULL, NULL);",
                                    "INSERT INTO TableFormControl (FkFormId, FkParentId, Name, FormControlFunction1, FormControlFunction2, TypeNo, Type, Width, Height, LocationX, LocationY, StartPosition, Caption1, Caption2, List, Dock, Alignment, TextAlignment, CharacterCasing, Font, Icon, ToolTip, Image, ImageSelected, FontAutoHeight, FontSize, InputType, TextImageRelation, BackColor, ForeColor, KeyboardValue) VALUES (2, 0, 'PAYMENT', 'CASH_PAYMENT', NULL, 1, 'BUTTON', 150, 167, 640, 243, NULL, 'CASH', NULL, NULL, NULL, NULL, 'CENTER', 'UPPER', 'Tahoma', NULL, NULL, NULL, NULL, 1, 18, 'ALPHANUMERIC', NULL, NULL, NULL, NULL);",
                                    "INSERT INTO TableFormControl (FkFormId, FkParentId, Name, FormControlFunction1, FormControlFunction2, TypeNo, Type, Width, Height, LocationX, LocationY, StartPosition, Caption1, Caption2, List, Dock, Alignment, TextAlignment, CharacterCasing, Font, Icon, ToolTip, Image, ImageSelected, FontAutoHeight, FontSize, InputType, TextImageRelation, BackColor, ForeColor, KeyboardValue) VALUES (2, 0, 'BARCODE', 'SALE_PLU_BARCODE', NULL, 1, 'BUTTON', 100, 100, 321, 250, NULL, '', NULL, NULL, NULL, NULL, 'CENTER', 'UPPER', 'Tahoma', NULL, NULL, NULL, NULL, 1, 18, 'ALPHANUMERIC', NULL, NULL, NULL, NULL);",
                                    "INSERT INTO TableFormControl (FkFormId, FkParentId, Name, FormControlFunction1, FormControlFunction2, TypeNo, Type, Width, Height, LocationX, LocationY, StartPosition, Caption1, Caption2, List, Dock, Alignment, TextAlignment, CharacterCasing, Font, Icon, ToolTip, Image, ImageSelected, FontAutoHeight, FontSize, InputType, TextImageRelation, BackColor, ForeColor, KeyboardValue) VALUES (2, 0, 'BARCODE', 'SALE_PLU_BARCODE', NULL, 1, 'BUTTON', 100, 100, 421, 250, NULL, '', NULL, NULL, NULL, NULL, 'CENTER', 'UPPER', 'Tahoma', NULL, NULL, NULL, NULL, 1, 18, 'ALPHANUMERIC', NULL, NULL, NULL, NULL);",
                                    "INSERT INTO TableFormControl (FkFormId, FkParentId, Name, FormControlFunction1, FormControlFunction2, TypeNo, Type, Width, Height, LocationX, LocationY, StartPosition, Caption1, Caption2, List, Dock, Alignment, TextAlignment, CharacterCasing, Font, Icon, ToolTip, Image, ImageSelected, FontAutoHeight, FontSize, InputType, TextImageRelation, BackColor, ForeColor, KeyboardValue) VALUES (2, 0, 'PAYMENT', 'CREDIT_PAYMENT', NULL, 1, 'BUTTON', 150, 100, 640, 411, NULL, 'CREDIT CARD', NULL, NULL, NULL, NULL, 'CENTER', 'UPPER', 'Tahoma', NULL, NULL, NULL, NULL, 1, 18, 'ALPHANUMERIC', NULL, NULL, NULL, NULL);",
