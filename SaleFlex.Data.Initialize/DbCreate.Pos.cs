                        ...
                        if (iResult >= 0)
                        {
                            ...
                            if (CommonProperty.prop_bIsOfflinePos)
                            {
                                string[] straQueries = new string[]
                                {
                                    ...
                                    "INSERT INTO TableFormControl (FkFormId, FkParentId, Name, FormControlFunction1, FormControlFunction2, TypeNo, Type, Width, Height, LocationX, LocationY, StartPosition, Caption1, Caption2, List, Dock, Alignment, TextAlignment, CharacterCasing, Font, Icon, ToolTip, Image, ImageSelected, FontAutoHeight, FontSize, InputType, TextImageRelation, BackColor, ForeColor, KeyboardValue) VALUES (2, 0, 'EXIT', 'EXIT_APPLICATION', NULL, 1, 'BUTTON', 100, 100, 101, 603, NULL, 'EXIT', NULL, NULL, NULL, NULL, 'CENTER', 'UPPER', 'Tahoma', NULL, NULL, NULL, NULL, 0, 12, 'ALPHANUMERIC', NULL, NULL, NULL, NULL);",
                                    ...
                                    "INSERT INTO TableFormControl (FkFormId, FkParentId, Name, FormControlFunction1, FormControlFunction2, TypeNo, Type, Width, Height, LocationX, LocationY, StartPosition, Caption1, Caption2, List, Dock, Alignment, TextAlignment, CharacterCasing, Font, Icon, ToolTip, Image, ImageSelected, FontAutoHeight, FontSize, InputType, TextImageRelation, BackColor, ForeColor, KeyboardValue) VALUES (2, 0, 'DEPARTMENT3', 'SALE_DEPARTMENT', NULL, 1, 'BUTTON', 125, 100, 1, 404, NULL, 'INDIVIDUAL', NULL, NULL, NULL, NULL, 'CENTER', 'UPPER', 'Tahoma', NULL, NULL, NULL, NULL, 0, 10, 'ALPHANUMERIC', NULL, NULL, NULL, NULL);",
