                        ...
                        if (iResult >= 0)
                        {
                            ...
                            if (CommonProperty.prop_bIsOfflinePos)
                            {
                                string[] straQueries = new string[]
                                {
                                    ...
                                    "INSERT INTO TableFormControl (FkFormId, FkParentId, Name, FormControlFunction1, FormControlFunction2, TypeNo, Type, Width, Height, LocationX, LocationY, StartPosition, Caption1, Caption2, List, Dock, Alignment, TextAlignment, CharacterCasing, Font, Icon, ToolTip, Image, ImageSelected, FontAutoHeight, FontSize, InputType, TextImageRelation, BackColor, ForeColor, KeyboardValue) VALUES (2, 0, 'LOGIN', 'LOGIN', NULL, 1, 'BUTTON', 200, 100, 412, 220, NULL, 'LOGIN', NULL, NULL, NULL, NULL, 'CENTER', 'UPPER', 'Tahoma', NULL, NULL, NULL, NULL, 1, 0, 'ALPHANUMERIC', NULL, NULL, NULL, NULL);",
