                        ...
                        if (iResult >= 0)
                        {
                            ...
                            if (CommonProperty.prop_bIsOfflinePos)
                            {
                                string[] straQueries = new string[]
                                {
                                    ...
                                    "INSERT INTO TableFormControl (FkFormId, FkParentId, Name, FormControlFunction1, FormControlFunction2, TypeNo, Type, Width, Height, LocationX, LocationY, StartPosition, Caption1, Caption2, List, Dock, Alignment, TextAlignment, CharacterCasing, Font, Icon, ToolTip, Image, ImageSelected, FontAutoHeight, FontSize, InputType, TextImageRelation, BackColor, ForeColor, KeyboardValue) VALUES (2, 0, 'PLU1', 'SALE_PLU_CODE', NULL, 1, 'BUTTON', 100, 100, 1, 102, NULL, '', NULL, NULL, NULL, NULL, 'CENTER', 'UPPER', 'Tahoma', NULL, NULL, NULL, NULL, 1, 18, 'ALPHANUMERIC', NULL, NULL, NULL, NULL);",
