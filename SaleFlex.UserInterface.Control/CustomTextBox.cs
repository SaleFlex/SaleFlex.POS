...
namespace SaleFlex.UserInterface.Controls
{
    public class CustomTextBox : TextBox, ICustomControl
    {
        ...
        public CustomTextBox(FormControlDataModel prm_xFormControlDataModel)
        {
            xFormControlsDataModel = prm_xFormControlDataModel;
            vInitializeCustomTextBoxComponents(prm_xFormControlDataModel);
        }

        public void vInitializeCustomTextBoxComponents(FormControlDataModel prm_xFormControlDataModel)
        {
            ((Control)this).bSetControlCommonProperties(prm_xFormControlDataModel);

            Multiline = false;

            if (prm_xFormControlDataModel.strCharacterCasing != string.Empty)
            {
                switch (prm_xFormControlDataModel.strCharacterCasing)
                {
                    case "NORMAL":
            ...
            m_strInputType = prm_xFormControlDataModel.strInputType;
        }
