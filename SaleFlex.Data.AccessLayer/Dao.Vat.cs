    ...
    public partial class Dao
    {
        public VatDataModel xGetVatById(int prm_strVatId)
        {
            try
            {
                ...
                DataTable xDataTable = Dbo.xGetInstance(CommonProperty.prop_strDatabaseProductsFileNameAndPath).xExecuteDataTable(strCommandText);
        ...
        public void vSaveVat(VatDataModel prm_xVatDataModel)
        {
            ...
            try
            {
                DataTable xDataTable = Dbo.xGetInstance(CommonProperty.prop_strDatabaseProductsFileNameAndPath).xExecuteDataTable(string.Format("INSERT INTO TableVat VALUES({0},{1},{2},{3},{4}); SELECT last_insert_rowid()",
