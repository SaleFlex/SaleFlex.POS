...
namespace SaleFlex.Data.AccessLayer
{
    public partial class Dao
    {
        ...
        public void vSavePluBarcode(PluBarcodeDataModel prm_xPluBarcodeDataModel)
        {
            ...
            try
            {
                DataTable xDataTable = Dbo.xGetInstance(CommonProperty.prop_strDatabaseProductsFileNameAndPath).xExecuteDataTable(string.Format("INSERT INTO TablePluBarcode VALUES({0},{1},{2},{3},{4},{5}); SELECT last_insert_rowid()",
